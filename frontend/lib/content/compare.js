...
export const COMPARISONS = [
  {
    ...
    ar: {
      ...
      rows: [
        ...
        ["الدفعات وتواريخ الصلاحية", "بالذاكرة", "عمود إضافي دون تنبيه", "FEFO تلقائي وتنبيه يومي"],
        ...
        ["النسخ الاحتياطي", "لا يوجد", "إن تذكّرت", "يومي على السحابة أو سكربت على خادمك"],
      ...
      verdict: [
        ...
        "فيزانو مصمّم للانتقال في ظهيرة واحدة: استورد منتجاتك من ملف إكسل نفسه، أدخل الرصيد الافتتاحي، وابدأ البيع. البيانات تبقى ملكك وتُصدَّر كاملة في أي وقت.",
      ],
    ...
    en: {
      ...
      rows: [
        ...
        ["Batches and expiry dates", "From memory", "An extra column, no alert", "Automatic FEFO and a daily alert"],
        ...
        ["Backups", "None", "If you remember", "Daily in the cloud, or a script on your server"],
      ...
      verdict: [
        ...
        "Vezano is designed for a one-afternoon move: import your products from the same Excel file, enter opening stock, and start selling. The data remains yours and exports in full at any time.",
      ],
