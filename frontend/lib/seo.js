...
export function softwareApplicationJsonLd() {
  return {
    ...
    inLanguage: ["ar", "en"],
    description:
      "نظام إدارة متكامل للمتاجر والشركات بفرع أو عدة فروع: المبيعات والمخزون والمشتريات والعملاء والموظفون والإدارة المالية في نظام واحد، والبيع يستمر بلا إنترنت ويُزامَن عند عودة الاتصال.",
    featureList: [
      "نقطة بيع تعمل بلا إنترنت وتزامن تلقائي",
      "مخزون بالدفعات وتواريخ الصلاحية (FEFO) ومستودعات متعددة",
      "مشتريات وموردون ومرتجعات",
      "إدارة علاقات العملاء وكشوف الحساب والتحصيل",
      "موارد بشرية وحضور وإجازات ورواتب",
      "إدارة مالية: مصروفات وموازنات وأرباح وخسائر وتدفق نقدي وزكاة",
      "فروع متعددة و12 دورًا بصلاحيات حسب الفرع",
