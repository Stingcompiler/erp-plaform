...
export const homeEn = {
  ...
  showcaseEyebrow: "Stores on Vezano",
  showcaseTitle: "Real shops, with a real page",
  showcaseBody: "Every subscription includes a public page for the business: cover, logo, products with photos, WhatsApp and a map, indexed by Google. These are some of them.",
  showcaseAll: "All stores",
...
export const homeAr = {
  ...
  showcaseEyebrow: "متاجر تعمل بفيزانو",
  showcaseTitle: "محلات حقيقية، بصفحة حقيقية",
  showcaseBody: "كل اشتراك يشمل صفحة عامة للنشاط: غلاف وشعار ومنتجات بالصور وواتساب وخريطة، تُفهرس في Google. هذه بعضها.",
  showcaseAll: "كل المتاجر",
