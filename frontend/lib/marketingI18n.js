...
// vezano.app/track/ — one search for web orders from any store and for the
// visitor's own requests with Vezano. Merged under `track`.
export const trackEn = {
  ...
  search: "Search",
  searching: "Searching…",
  notFound: "Nothing found. Check the reference, the phone/WhatsApp number or the email, or write the name exactly as you did when ordering or registering.",
  limited: "Sorry, that was a lot of searches in a short time. Please wait a few minutes and try again, or use the link you received.",
  error: "The search could not be completed. Check your connection and try again.",
  count: "{count} results",
  kinds: {
    order: "Web order",
  ...
  items: "Items",
  total: "Total",
  totalTaxed: "Total including tax",
  amount: "Amount",
  reason: "Reason",
  next: "What happens next",
  delivery: "Delivery",
  pickup: "Pickup",
  questions: "Questions about this order:",
  openStore: "Open the store's tracking page",
  payment: {
    verified: "Transfer verified",
    pending: "Transfer being checked",
    not_verified: "The declared transfer was not verified — contact the store",
  },
  privacy: "For your privacy we never show phone numbers, emails or addresses, and show names as initials.",
  thankYouTrack: "Follow it any time on the tracking page",
  referenceLabel: "Your request number",
};
...
export const trackAr = {
  ...
  notFound: "لم نجد شيئاً بهذه البيانات. تأكد من رقم الطلب أو رقم الهاتف/واتساب أو البريد، أو اكتب الاسم كما كتبته عند الطلب أو التسجيل.",
  limited: "عذراً، بحثت كثيراً خلال وقت قصير. انتظر بضع دقائق ثم حاول مجدداً، أو استخدم الرابط الذي وصلك.",
  error: "تعذّر إكمال البحث. تحقق من اتصالك وحاول مجدداً.",
  count: "{count} نتيجة",
  kinds: {
    order: "طلب من متجر",
    registration: "طلب تسجيل",
    demo: "طلب عرض تجريبي",
  ...
  items: "المنتجات",
  total: "الإجمالي",
  totalTaxed: "الإجمالي شامل الضريبة",
  amount: "المبلغ",
  reason: "السبب",
  next: "ماذا بعد",
  delivery: "توصيل",
  pickup: "استلام من المحل",
  questions: "لأي سؤال عن الطلب:",
  openStore: "افتح صفحة التتبّع في المتجر",
  payment: {
    verified: "تم التحقق من التحويل",
    pending: "التحويل قيد التحقق",
    not_verified: "لم يتأكد التحويل المسجّل — راجع المتجر",
  },
