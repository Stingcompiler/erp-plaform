...
export const registerEn = {
  ...
  hosted: "Hosted (cloud)",
  hostedHint: "We run it for you: nothing to install, works from any device, updates and backups are on us. Start with a 14-day free trial.",
    ...
    options: [
      {
        key: "saas",
        title: "Hosted (cloud)",
        tagline: "The fastest way to start: a workspace ready within a day of approval.",
        points: [
          ...
          "Updates, backups and security are handled by us; you never run maintenance.",
          "Monthly or yearly subscription per plan; add branches, users and devices as you grow.",
          "Bank-app payments (Bankak, Fawri, O-Cash) and WhatsApp notifications work out of the box.",
        ],
...
export const registerAr = {
  ...
  hosted: "على السحابة",
  hostedHint: "نشغّله لك: لا تركيب، يعمل من أي جهاز، والتحديثات والنسخ الاحتياطي علينا. ابدأ بتجربة مجانية 14 يومًا.",
    ...
    options: [
      {
        key: "saas",
        title: "على السحابة",
        tagline: "أسرع طريقة للبدء: مساحة عمل جاهزة خلال يوم من الموافقة.",
        points: [
          ...
          "التحديثات والنسخ الاحتياطي والأمان مسؤوليتنا؛ لا صيانة عليك أبدًا.",
          "اشتراك شهري أو سنوي حسب الباقة؛ أضف فروعًا ومستخدمين وأجهزة كلما كبرت.",
          "مدفوعات تطبيقات البنوك (بنكك، فوري، أوكاش) وإشعارات واتساب تعمل مباشرة.",
        ],
