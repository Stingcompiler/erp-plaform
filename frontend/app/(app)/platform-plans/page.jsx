...
function PlanEditor({ plan, onSaved, t }) {
  ...
  const save = async (event) => {
    ...
    } catch (requestError) { setError(errorText(requestError, t, "platformPlans.saveError")); } finally { setSaving(false); }
  };
