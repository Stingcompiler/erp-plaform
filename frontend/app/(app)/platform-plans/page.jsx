...
const EMPTY = { code: "", name: "", description: "", currency: "USD", price: "", billing_cycle: "monthly", modules: ["inventory", "sales"], users: "", branches: "", warehouses: "", devices: "", ...EMPTY_COPY };
...
function PlanEditor({ plan, onSaved, t }) {
  ...
  const initial = () => ({
    ...
    users: latest?.limits?.users ?? "", branches: latest?.limits?.branches ?? "", warehouses: latest?.limits?.warehouses ?? "", devices: latest?.limits?.devices ?? "",
  });
